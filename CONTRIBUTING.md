...
Welcome to `opensemantic.meta.legal` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.meta.legal`, please have a look
...
You can help improve `opensemantic.meta.legal` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.meta.legal` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.meta.legal`'s files. While this mechanism can
...
```
conda create -n opensemantic.meta.legal python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.meta.legal
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.meta.legal.git
   cd opensemantic.meta.legal
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.meta.legal` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.meta.legal
[issue tracker]: https://github.com/<USERNAME>/opensemantic.meta.legal/issues
